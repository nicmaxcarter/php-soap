...
class WSSoapClient extends SoapClient
{
    ...
    private function generateWSSecurityHeader()
    {
        ...
        <wsse:UsernameToken>
            <wsse:Username>max@CDSTTRANSP</wsse:Username>
            <wsse:Password Type="http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-username-token-profile-1.0#PasswordText">FedEx19$</wsse:Password>
        </wsse:UsernameToken>
    </wsse:Security>';
